...
class CTinyCharTest : public CBaseTestCase
{
public:
public:
    CTinyCharTest()
    ...
    virtual void SetUp() {
        ...
        m_pTestCaseBuilder->feature("CTinyCharTest");
    }


};

TEST_F(CTinyCharTest, TrendlineDiagram)
{
...
TEST_F(CTinyCharTest, DistributionDiagram)
{
